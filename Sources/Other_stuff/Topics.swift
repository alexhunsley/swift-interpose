...
//    }
//
//    // NEXT: look at manually adding a build to the topics you want,
//    // rather than haing a free-for-all. Using e.g. a mixin helper
//
//
...
//    }
//
//    protocol ActionBuildable {}
//
//    // more focused builders with their own name. Useful when you don't want all aspects
//    // available to all topics
//    extension Topic {
...
//    //}
//
//    // WAS HERE trying to test the XBuildable thing!
//    enum SettingsTopic: Topic, Equatable {
//    //enum SettingsTopic: Topic, ActionBuildable, Equatable {
//        case screenViewed
//        case screenDismissed
...
//    struct LoginAction: TopicRepresentable, ActionBuildable {
//        let topic: LoginTopic
//    }
//
...
//
//        // this fails as hoped, because SettingsTopic doesn't adopt ActionBuildable so it's not available
//    //    let settingsActionFromBuild_B: SettingsAction = SettingsTopic.screenViewed.buildAction()
//
//
